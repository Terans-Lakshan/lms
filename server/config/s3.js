...
//         // Safely check if Contents exists and has items
        ...
        fileFilter:function(req,file,cb){
            ...
            if(uploadType === 'degree-preview'){
                ...
                if(!file.mimetype.startsWith('image/')){
                    ...
                    return cb(
                        new Error(
                            'Only image files are allowed for degree preview!'
                        ),
                        false
                    );
...
export const createS3Folder = async(folderPath)=>{
    ...
    try{
        ...
        console.error(
            `Error creating S3 folder ${folderPath}:`,
            error
        );
...
export const deleteS3Folder = async(folderPath)=>{
    ...
    try{
        ...
        if(contents.length === 0){
            ...
            console.log(
                `No objects found in folder: ${folderPath}`
            );
        ...
        console.log(
            `Deleted S3 folder and contents: ${folderPath}`
        );
        ...
        console.error(
            `Error deleting S3 folder ${folderPath}:`,
            error
        );
